...
> For leaderboard/ranking data, see [Track A Leaderboard API](../advanced-api-docs/leaderboard.md) (`GET /api/v1/tracka/ranking/self`) and [Track B Ranking — Self Query](../advanced-api-docs/trackb-ranking-self.md) (`GET /api/v1/trackb/ranking/self`).
...
| GET | `/api/v1/trading/userFeeRate` | Maker/Taker fee rates + `level` tier (portfolio key) | [→](../advanced-api-docs/user-trading-fee-rate.md) |
