...
| `rapidx portfolio user-fee-rate` | `rapidx/portfolio/user-fee-rate` | `GET /api/v1/broker/feeRate` (main portfolio fee rate; sub-portfolio fee rate uses `GET /api/v1/broker/sub/feeRate` and is not exposed as a separate CLI/MCP tool) |
